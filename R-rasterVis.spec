...
Version  : 0.44
Release  : 9
URL      : https://cran.r-project.org/src/contrib/rasterVis_0.44.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rasterVis_0.44.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1522952953
