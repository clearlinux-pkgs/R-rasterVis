...
Version  : 0.49
Release  : 37
URL      : https://cran.r-project.org/src/contrib/rasterVis_0.49.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rasterVis_0.49.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604520692
