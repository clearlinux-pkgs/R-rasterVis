...
Version  : 0.48
Release  : 34
URL      : https://cran.r-project.org/src/contrib/rasterVis_0.48.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rasterVis_0.48.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592415784
