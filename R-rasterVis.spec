...
Version  : 0.50.3
Release  : 47
URL      : https://cran.r-project.org/src/contrib/rasterVis_0.50.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rasterVis_0.50.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627052498
